...
db = SQLDatabase.from_uri(
    "mysql+mysqlconnector://root:{password}@localhost:3306/ecommerce"
)
...
def create_agent_for_sql(tool_llm_name="gpt-4o-mini", agent_llm_name="gpt-4o-mini"):
    ...
    message_history = SQLChatMessageHistory(
        ...
        connection_string="mysql+mysqlconnector://root:{password}@localhost:3306/ecommerce", # use this if password need f"mysql://root:{password}@localhost:3306/ecommerce"
